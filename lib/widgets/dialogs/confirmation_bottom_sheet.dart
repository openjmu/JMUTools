...
import 'package:jmu_tools/constants/styles.dart';
import 'package:jmu_tools/exports/extensions.dart';
import 'package:jmu_tools/exports/widgets.dart';
import 'package:jmu_tools/models/theme_group.dart';
    ...
    return MaterialButton(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: context.themeColor.withOpacity(0.9),
        ),
        child: Center(
          child: Text(
            widget.confirmLabel,
